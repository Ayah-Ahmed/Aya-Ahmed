        ...
        <form action="{{ route('dashboard.products.store') }}" method="post"
            ...
            <div class="card ">
                    ...
                    <div class="form-row ">
                        ...
                        <div class="form-row">
                            <div class="col-6">
                                ...
                                <textarea name="desc_en" id="desc_en" cols="70" rows="10" class="form-control">{{ old('desc_en') }}</textarea>
                                @error('desc_en')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-6">
                                ...
                                <textarea name="desc_ar" id="desc_ar" cols="70" rows="10" class="form-control">{{ old('desc_ar') }}</textarea>
                                @error('desc_ar')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card-footer text-muted">
                    <button class="btn btn-outline-primary bt-sm rounded" name="redirect" value="index">Create</button>
                    <button class="btn btn-outline-primary bt-sm rounded" name="redirect" value="create">Create&Return
                        back</button>
                </div>
            </div>
        </form>
